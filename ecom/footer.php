    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-12">
                ...
                <a href="mailto:douaetarzigue04@gmail.com">
                    <form class="form-row">
                        <div class="col">
                            <textarea name="career[message]" class="form-control" tabindex="4" placeholder="Message" style="height: 38px;" required></textarea>
                        </div>
                        <div class="col">
